...
from abstract_paths.content_utils.src.diff_engine import *
from abstract_paths.content_utils.src.diff_utils import *
from abstract_paths.content_utils.src.file_utils import *
from abstract_paths.content_utils.src.find_content import *
...
from robustLogger.robust_utils import get_log_file_path, attach_textedit_to_logs
from robustLogger.logHandler import set_self_log
# your code: the functions you pasted
from abstract_paths.content_utils.src.find_content import ( # <- change to your package path
    findContent, findContentAndEdit, getLineNums, get_line_content
)
from abstract_paths import findContent, findContentAndEdit,get_directory_map, findGlobFiles,collect_filepaths,define_defaults,get_py_script_paths
...
class FinderWindow(QWidget):
    def __init__(self):
        ...
        self.diff_parser = DiffParserTab()
        tabs.addTab(self.diff_parser, "Diff Parser")
